...
(function () {
  ...
  if (levelsWrap) {
    levelsWrap.innerHTML =
      '<p class="data-loading">Cargando cursos…</p>';
  }
  data
    .load()
    ...
    .catch(function (err) {
      console.error("No se pudo cargar la Academia:", err);
      if (levelsWrap) {
        levelsWrap.innerHTML =
          '<p class="data-error">No se pudieron cargar los cursos. Por favor, recarga la página.</p>';
      }
    });
})();
